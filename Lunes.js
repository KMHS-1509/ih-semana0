...
//LO QUE ESTÁ ADENTRO DEL PARENTÉSIS SE LE CONOCE COMO EXPRESIÓN
...
if(hora > 0000 > 1159) {console.log ("Buenos días")
}

if (1200 > 1759) {console.log ("Buenas tardes")
}

if (1800 > 2359) {console.log ("Buenas noches")
}
else {
    console.log("Hora no válida")
} 

const 0020 = buenos días
